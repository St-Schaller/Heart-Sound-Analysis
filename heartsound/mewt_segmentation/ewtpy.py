...
import numpy as np
#%EWT functions 
def EWT1D(f,N=0, log = 0,detect = "locmax", completion = 0, reg = 'average', lengthFilter = 10,sigmaFilter = 5):
    """
     =========================================================================
    ...
    boundaries = np.empty(2)
    print(max_x, max_y)
    boundaries[0] = max_x - 0.040
    print(boundaries[0])
    boundaries[1] = max_x + 0.040
    print(boundaries[1])
    #print(boundaries)
